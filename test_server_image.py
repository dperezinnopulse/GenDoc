#!/usr/bin/env python3
"""
Script para probar la funcionalidad de imagen con el servidor simple.
"""
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if 'application/pdf' in content_type:
                ...
                with open('test_server_output.pdf', 'wb') as f:
                    f.write(response.content)
                print("   💾 PDF guardado como 'test_server_output.pdf'")
                return True
            else:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if 'image/png' in content_type:
                ...
                with open('test_server_output.png', 'wb') as f:
                    f.write(response.content)
                print("   💾 Imagen guardada como 'test_server_output.png'")
                return True
            else:
                print(f"❌ Content-Type inesperado: {content_type}")
...
def main():
    ...
    print("🚀 INICIANDO PRUEBAS DEL SERVIDOR SIMPLE")
    print("=" * 50)
    ...
    if passed == total:
        ...
        print("\n📁 Archivos generados:")
        print("   📄 test_server_output.pdf - Documento PDF de prueba")
        print("   🖼️  test_server_output.png - Imagen convertida")
    else:
